 ...
 */
final class Version20260304134931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE covoiturage (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, date_depart DATE NOT NULL, heure_depart TIME(0) WITHOUT TIME ZONE NOT NULL, lieu_depart VARCHAR(50) NOT NULL, date_arrivee DATE NOT NULL, heure_arrivee TIME(0) WITHOUT TIME ZONE NOT NULL, lieu_arrivee VARCHAR(50) NOT NULL, nb_place INT NOT NULL, prix_personne NUMERIC(10, 2) NOT NULL, statut VARCHAR(50) NOT NULL, utilisateur_id INT DEFAULT NULL, voiture_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE role (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, libelie VARCHAR(50) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE utilisateur (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, telephone VARCHAR(50) NOT NULL, adresse VARCHAR(50) NOT NULL, date_naissance DATE NOT NULL, photo BYTEA NOT NULL, pseudo VARCHAR(50) NOT NULL, role_id INT DEFAULT NULL, PRIMARY KEY (id))');
